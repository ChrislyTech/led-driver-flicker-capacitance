...
1. the design equations of the course notes, applied to the worked example on off-line drivers;
...
Taken from the single-stage buck-boost example of the course notes:
...
**LED current ripple as a function of the bus capacitance** (course notes)
